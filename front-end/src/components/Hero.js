...
import accentImage from "../assets/accentImage.jpg"
  ...
  return (
    <Wrapper className='section-center'>
      ...
      <article className='img-container'>
        <img src={accentImage} alt='nice table' className='main-img' />
        <img src={MainSneaker} alt='person working' className='accent-img' />
      </article>
    </Wrapper>
  )
}
